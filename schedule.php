...
$query = "SELECT classes.*, instructors.instructor_image, instructors.name AS instructor_name
 FROM classes
...
<div class="instructor-name" style="font-size: 18px; font-weight: 500; color: #333333;">&#128100; <?php echo htmlspecialchars($class['instructor_name']); ?></div>
...
<div class="class-action" style="text-align: right;">
...
<?php endif; ?>
 ...
 <!-- Class Details -->
 <div class="class-details" style="margin-top: 20px;">
